        ...
        <div class="row py-1">
            ...
            <div class="col-sm-12 col-md-6 col-xl-3 ">
                <div class="text-center py-5">
                    ...
                    <p class="p-3 text-white">Stand a chance to win whitelist/NFT giveaways by our partners.</p>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-xl-3">
                <div class="text-center py-5">
                    ...
                    <p class="p-3 text-white">The higher level you are the more priority you are given to join our partner's game Early Access.</p>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-xl-3">
                <div class="text-center py-5">
                    ...
                    <p class="p-3 text-white">Win random bounties by being active in the community.</p>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-xl-3">
                <div class="text-center py-5">
                    ...
                    <p class="p-3 text-white">Participate in our events to level up.</p>
                </div>
            </div>
...
<div class="container-fluid pt-4 bg-gray">
    <div class="row foc">
        ...
        <img class="col-lg-4 col-md-6 col-sm-12" src="img/hdr1.jpg" />
        <div class="col-lg-8 col-md-6 col-sm-12">
            <p class="p-5">Impact Realm provides all the tools for blockchain games and metaverses to
